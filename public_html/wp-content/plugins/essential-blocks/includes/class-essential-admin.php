...
class EssentialAdmin {
    ...
    public function __construct() {
        ...
        register_activation_hook( ESSENTIAL_BLOCKS_FILE, [ $this, 'activate' ] );
    ...
    public function plugin_update( $plugin_data, $new_data ) {
        ...
        EBHelpers::version_update_warning( $plugin_data['Version'], $plugin_data['new_version'], $upgrade_notice );
    }
}
