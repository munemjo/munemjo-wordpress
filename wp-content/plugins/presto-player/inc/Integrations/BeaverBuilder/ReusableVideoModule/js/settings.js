        ...
        (function (global, factory) {
            ...
            return tryCatch(
              () => {
                ...
                /* MODERN-ONLY:START */ AsyncFunction = Object.getPrototypeOf(
                  async function () {}
                ).constructor; // For the cases when users pass only a function reference to the caller: `x-on:click="foo"`
                /* MODERN-ONLY:END */ // Where "foo" is a function. Also, we'll pass the function the event instance when we call it.
          ...
          class Component {
            constructor(el3, componentForClone = null) {
              ...
              /* MODERN-ONLY:START */ // In IE11, we have already defined our helpers at this point.
